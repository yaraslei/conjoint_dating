...
$featurearray = array("Beauty" => array("High","Low"),"Race" => array("Black","White"),"Height" => array("Tall","Short"),"Affect" => array("Open to match with anyone!","No Tories!","No Labour!"),"Education" => array("Degree","No degree"),"Party" => array("Labour","Tory"),"Diet" => array("Vegetarian, trying to be vegan","None"),"Ideology" => array("Progressive","Traditional"));

$restrictionarray = array(array(array("Affect","No Tories!"),array("Party","Tory")),array(array("Affect","No Labour!"),array("Party","Labour")));

$probabilityarray = array("Beauty" => array(0.5,0.5),"Race" => array(0.2,0.8),"Height" => array(0.5,0.5),"Affect" => array(0.3333333333333333,0.3333333333333333,0.3333333333333333),"Education" => array(0.5,0.5),"Party" => array(0.5,0.5),"Diet" => array(0.2,0.8),"Ideology" => array(0.5,0.5));
